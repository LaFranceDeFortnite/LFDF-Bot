...
module.exports = (client) => {
    ...
    client.on('message', message => {
        if(message.content === "!fun") {
            ...
            client.channels.get("664916311838687242").send("Log / Utilisateur **" + message.author.username + "** / Commande **Fun**");
        }
        if(message.content === "!help") {
            ...
            client.channels.get("664916311838687242").send("Log / Utilisateur **" + message.author.username + "** / Commande **Help**");
        }
        if(message.content === prefix + "modo") {
            ...
            .setTimestamp()
             ...
             client.channels.get("664916311838687242").send("Log / Utilisateur **" + message.author.username + "** / Commande **Modo**");
        }
        if(message.content === prefix + "reseaux") {
            ...
            .setTimestamp()
             ...
             client.channels.get("664916311838687242").send("Log / Utilisateur **" + message.author.username + "** / Commande **Réseaux**");
        }
        if(message.content === prefix + "serveur-info") {
            ...
            client.channels.get("664916311838687242").send("Log / Utilisateur **" + message.author.username + "** / Commande **Info**");
        }
        if(message.content === prefix + "projet") {
            ...
            client.channels.get("664916311838687242").send("Log / Utilisateur **" + message.author.username + "** / Commande **Projet**");
        }
        if(message.content === prefix + "ah") {
            ...
            client.channels.get("664916311838687242").send("Log / Utilisateur **" + message.author.username + "** / Commande **Ah (Deny)**");
        }
        ...
        message.delete();
        client.channels.get("664916311838687242").send("Log / Utilisateur **" + message.author.username + "** / Commande **Say Embed**");
        }
    });
};
