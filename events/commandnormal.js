...
module.exports = (client) => {
    ...
    client.on('message', message => {
        if(message.content === "!bravo") {
            ...
            client.channels.get("664916311838687242").send("Log / Utilisateur **" + message.author.username + "** / Commande **Bravo**");
        }
        if(message.content === "!twitch") {
            message.channel.sendMessage('Twitch du Discord : https://www.twitch.tv/lafrancedefortnite');
            client.channels.get("664916311838687242").send("Log / Utilisateur **" + message.author.username + "** / Commande **Twitch**");
        }
        if(message.content === "!youtube") {
            ...
            client.channels.get("664916311838687242").send("Log / Utilisateur **" + message.author.username + "** / Commande **YouTuBe**");
        }
        if(message.content === "!twitter") {
            message.channel.sendMessage('Twitter du Discord : https://twitter.com/LaFranceDeFort1');
            client.channels.get("664916311838687242").send("Log / Utilisateur **" + message.author.username + "** / Commande **Twitter**");
        }
        if(message.content === "!lfdfanimation") {
            message.channel.sendMessage('LFDF Animation : https://discord.gg/cGhSxbN');
            client.channels.get("664916311838687242").send("Log / Utilisateur **" + message.author.username + "** / Commande **Discord LFDF Animation**");
        }
        if(message.content === "!dm") {
            ...
            client.channels.get("664916311838687242").send("Log / Utilisateur **" + message.author.username + "** / Commande **DM**");
        }
        ...
        if(message.content === "!boutique") {
            ...
            client.channels.get("664916311838687242").send("Log / Utilisateur **" + message.author.username + "** / Commande **Boutique**");
        }
    });
};
